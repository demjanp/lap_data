	...
	def get_default_descriptors(self):
		...
		if self._default_descriptors is None:
			...
			for name, chain in [
				...
				["RTI_Albedo",				"Sample.Drawn.RTI.Albedo"],
				["RTI_Normal_Map",			"Sample.Drawn.RTI.Normal_Map"],
				["RTI_Height_Map",			"Sample.Drawn.RTI.Height_Map"],
				["RTI_Settings",			"Sample.Drawn.RTI.Settings"],
				["RTI_Mask",				"Sample.Drawn.RTI.Mask"],
